...
* Результати виконання завдання *3*;
    1. Розробила першу програму на Python
    1. Програма вивела значення:Text variable: Hi there, this is an updated Python script
Integer: 12
Float: 2.718
...
* вставлені рисунки ![alt text]({A4EE15D2-0335-4CA9-9157-4860B4A2E180}.png) ![alt text]({EFE6CF3B-D220-40C0-B84C-B7AC74F34C6C}.png)![alt text]({F60D4BFA-9D5E-4B59-B056-C955CF8C9573}.png)
    

* вставлений код / текстовий або числовий результат / інші результати:
    - Text variable: Hi there, this is an updated Python script
Integer: 12
Float: 2.718
